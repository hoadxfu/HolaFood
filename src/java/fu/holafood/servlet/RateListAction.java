 ...
 * @author Ray Sparrow
 */
public class RateListAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!deleteAction.equals("") && updateAction.equals("")) {
            ...
            Rate p = um.getRateById(index);
            if (p != null) {
                request.setAttribute("rateUpdate", p);
                request.getRequestDispatcher("admin/ratting/list.jsp").forward(request, response);
            } else {
        ...
        if (!sent) {
            response.sendRedirect("admin/ratting/list.jsp");
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RateListAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
